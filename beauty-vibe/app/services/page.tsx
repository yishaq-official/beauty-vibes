...
export default function ServicesPage() {
  return (
    <div className="bg-[#0e0e0e] text-white min-h-screen relative overflow-hidden">
      {/* Background Glow */}
      <div className="fixed inset-0 -z-10 bg-[radial-gradient(circle_at_20%_30%,rgba(183,110,121,0.08),transparent_40%),radial-gradient(circle_at_80%_70%,rgba(255,255,255,0.04),transparent_40%)]" />
        ...
        >
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative rounded-3xl overflow-hidden border border-white/5 bg-gradient-to-br from-[#151515] to-[#111] hover:border-rosegold/40 transition-all duration-500 shadow-[0_0_30px_rgba(0,0,0,0.5)] flex flex-col justify-between"
            >
              {/* Popular Ribbon */}
              {index === 0 && (
              ...
              <div className="p-8 flex flex-col justify-between flex-grow">
                ...
                <button
                  ...
                  className="cursor-pointer w-full py-3.5 relative overflow-hidden group/btn rounded-full border border-rosegold bg-transparent text-rosegold font-bold uppercase tracking-wider text-sm transition-all duration-300"
                >
      ...
      <section className="relative py-28 text-center overflow-hidden">
        ...
        >
          ...
          <button
            ...
            className="cursor-pointer px-12 py-4 bg-rosegold text-black font-bold rounded-full hover:scale-105 hover:shadow-[0_0_40px_rgba(183,110,121,0.5)] transition-all duration-300"
          >
            Book Now
          </button>
        </motion.div>
