...
export default function CoursesPage() {
  return (
    <motion.div
      ...
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      className="relative pt-28 pb-24 px-6 overflow-hidden min-h-screen"
    >
      {/* ===== BACKGROUND LAYERS ===== */}
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-24">
          ...
          <div className="w-24 h-[2px] bg-gradient-to-r from-transparent via-rosegold to-transparent mx-auto mb-6" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
          {courses.map((course, index) => (
            <motion.div
              ...
              whileHover={{ y: -10 }}
              className="group relative rounded-3xl overflow-hidden border border-white/5 bg-white/[0.03] backdrop-blur-xl shadow-2xl transition-all duration-500 flex flex-col justify-between"
            >
              {/* Hover Glow */}
              ...
              {/* ===== CONTENT ===== */}
              <div className="relative p-8 flex flex-col justify-between flex-grow">
                <div>
                ...
                <button
                  ...
                  className="cursor-pointer relative w-full py-3 rounded-xl font-semibold tracking-wide overflow-hidden group/button"
                >
