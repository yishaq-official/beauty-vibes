    ...
    <>
      <header
        className={`fixed top-0 left-0 w-full z-40 transition-all duration-500 ${
          isScrolled
            ? 'bg-[#0f0f14]/85 backdrop-blur-xl shadow-lg border-b border-rosegold/20 py-3'
            : 'bg-transparent py-5'
        }`}
      >
        {/* Soft Glow Line */}
        ...
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-3 group">
            ...
            <div className="flex flex-col">
              <span className="text-2xl font-serif text-white tracking-wide group-hover:tracking-wider transition-all duration-300 leading-none">
                Beauty<span className="text-rosegold">Vibes</span>
              </span>
              <span className="text-[10px] tracking-widest text-rosegold uppercase font-sans font-semibold mt-1">
                Salon & Academy
              </span>
            </div>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-10">
            {navLinks.map((link) => (
              ...
              >
                ...
                {/* Animated Underline */}
                <span
                  className={`absolute left-0 -bottom-2 h-[2px] bg-rosegold transition-all duration-300 ${
          ...
          <div className="hidden md:block">
            <button
              ...
              className="cursor-pointer relative inline-block px-7 py-3 rounded-full font-semibold text-sm tracking-wider overflow-hidden group"
            >
              {/* Glow Background */}
          ...
          {/* MOBILE TOGGLE */}
          <button
            className="md:hidden text-gray-300 hover:text-rosegold transition-colors duration-300 p-1"
            ...
            >
              <div className="flex flex-col px-6 py-8 gap-7">
                ...
                <button
                  ...
                  className="cursor-pointer relative mt-4 py-3 text-center font-semibold tracking-wider rounded-full overflow-hidden group"
                >
